...
class GitLabProvider(GitProvider):
    ...
    def __init__(self, merge_request_url: Optional[str] = None, incremental: Optional[bool] = False):
        gitlab_url = get_settings().get("GITLAB.URL", None) or os.getenv("GITLAB_URL")
        if not gitlab_url:
        ...
        auth_method = get_settings().get("GITLAB.AUTH_TYPE", None) or os.getenv("GITLAB_AUTH_TYPE") or "oauth_token"
